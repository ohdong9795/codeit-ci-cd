export default function Spin() {
  return (
    <div className='w-[500px] h-[800px] relative ml-36'>
      <svg
        viewBox='0 0 1026 1026'
        fill='none'
        aria-hidden='true'
        className='absolute inset-0 w-[500px] h-[500px] animate-spin-slow'
      >
        <path
      ...
      <svg
        ...
        fill='none'
        aria-hidden='true'
        className='absolute inset-0 w-[500px] h-[500px] animate-spin-reverse-slower'
      >
        <path
